...
const CopyKitt: React.FC = () => {
  ...
  const ENDPOINT: string =
    "https://yhrw7blz7l.execute-api.us-west-2.amazonaws.com/prod/generate_snippet_and_keywords";
      ...
      <div className="max-w-md m-auto p-2">
        <div className="bg-slate-800 p-6 rounded-md text-white">
          <div className="text-center my-6">
            ...
            <h1 className={gradientTextStyle + " text-3xl font-normal"}>
              COPY COACH
            </h1>
            <div className={gradientTextStyle}>Your AI branding coach</div>
          </div>
